...
import com.example.projectservice.security.jwt.JwtAuthEntryPoint;
import com.example.projectservice.security.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        return username -> {
            throw new UsernameNotFoundException("JWT only - no user lookup");
        };
    }
}